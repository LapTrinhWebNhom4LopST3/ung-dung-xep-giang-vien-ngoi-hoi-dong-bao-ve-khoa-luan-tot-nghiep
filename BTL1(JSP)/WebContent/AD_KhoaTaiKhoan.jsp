  ...
  <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default">
              <div class="panel-heading"><h style=color:red>Khóa Tài Khoản</h></div>
                                      ...
                                      <div class="form-group">
                                         ...
                                         <div class="col-md-3">
                                              ...
                                              <div ng-show="form.name.$dirty && form.name.$invalid" class="text-danger"><i class="fa fa-times text-danger"></i>
                                                  ...
                                                  <span ng-show="form.name.$error.pattern">Tên tài khoản chỉ bao gồm các kí tự chữ cái</span>
                                              </div>
                                        </div>
                                     </div>        
                                      <div class="form-group">
...
<div class="row">
                    <div class="col-md-4" style="text-align:right;"> 
                      <p><h style=color:red>Thời hạn khóa:</h></p>
                       <br>
                       <br>
                   ...
                   <div class="col-md-5">
                      <div class="row" style="text-align: left ;">
                       <div class="radio">
                         <label><input type="radio" name="optradio">1day</label></div>
                           <div class="radio">
                          <label><input type="radio" name="optradio">7days</label></div>
                           <div class="radio">
                           <label><input type="radio" name="optradio">30days</label></div>
                              <div class="radio"><br>
